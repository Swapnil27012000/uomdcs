<div class="bg-white shadow-sm" id="sidebar-wrapper">
    <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold border-bottom">
        ...
        <span class="d-none d-md-inline">UoM DCS Portal</span>
    </div>
    <div class="list-group list-group-flush my-3">
        ...
        <a href="AddDepartmentDetails.php" class="list-group-item list-group-item-action rounded-3 mb-1">
            ...
            <span class="d-none d-md-inline">Add Department</span>
        </a>
        <a href="EditDepartmentDetails.php" class="list-group-item list-group-item-action rounded-3 mb-1">
            <i class="fas fa-edit me-2 text-warning"></i>
            <span class="d-none d-md-inline">Edit Department</span>
        </a>
        <a href="delete_department.php" class="list-group-item list-group-item-action rounded-3 mb-1">
            <i class="fas fa-trash-alt me-2 text-danger"></i>
            <span class="d-none d-md-inline">Delete Department</span>
        </a>
        <a href="Nirf_Data.php" class="list-group-item list-group-item-action rounded-3 mb-1">
