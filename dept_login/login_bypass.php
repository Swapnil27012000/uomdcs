    ...
    if (empty($recaptcha_error)) {
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            if ($found && $row && $userInfo) {
                ...
                // Debug logging
                error_log("Login_bypass Debug (dept_login) - Email: " . $email . ", Table: " . $table . ", Permission: [" . $permission_str . "], Lower: [" . $permission_lower . "]");
                ...
                if ($table === 'boss') {
                    ...
                    if (stripos($permission_check, 'aaqa') !== false || $permission_lower === 'aaqa_login' || $permission_lower === 'aaqa') {
                        error_log("AAQA Match Found in dept_login/login_bypass.php - Setting AAQA session for: " . $email);
                        $_SESSION['AAQA'] = true;
                    ...
                    switch ($permission_lower) {
                        ...
                        default:
                            ...
                            error_log("Unknown permission in dept_login/login_bypass.php: " . $permission . " (lower: " . $permission_lower . ") for user: " . $email);
